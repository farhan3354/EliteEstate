...
const Banner = () => {
  ...
  return (
    <>
      <section className="relative bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 text-white py-20 lg:py-28 overflow-hidden">
...
//   return (
//     <section className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-black py-20 lg:py-28 overflow-hidden">
