...
const PropertyDetails = () => {
  ...
  const property = {
    ...
    description: "This stunning 2-bedroom apartment offers breathtaking sea views and luxurious modern living in the heart of Al Reem Island. The property features high-quality finishes, spacious living areas, and access to world-class amenities.",
...
• Landscaped gardens`,
    ...
    features: [
      "Balcony", "Built-in Wardrobes", "Central Air Conditioning", "Concierge",
      "Covered Parking", "Swimming Pool", "Gym", "Sea View", "Modern Kitchen",
      "Walk-in Closet", "Smart Home", "Pet Friendly", "Security", "Maintenance"
    ],
    images: [
    ...
    amenities: {
      "Building Features": ["Swimming Pool", "Gym", "Security", "Concierge", "Children's Play Area"],
      "Apartment Features": ["Balcony", "Built-in Wardrobes", "Central AC", "Modern Kitchen", "Walk-in Closet"],
      "Additional Features": ["Sea View", "Covered Parking", "Pet Friendly", "Smart Home"],
    },
    locationDetails: {
      landmarks: [
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            <button onClick={() => navigate("/")} className="hover:text-orange-500 transition duration-200">
              Home
            </button>
            <span>›</span>
            <button onClick={() => navigate("/properties")} className="hover:text-orange-500 transition duration-200">
              Properties for Sale
            </button>
            <span>›</span>
            <button onClick={() => navigate(`/properties?category=${property.type}`)} className="hover:text-orange-500 transition duration-200">
              Apartments for Sale
            </button>
            <span>›</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg font-semibold transition duration-200 flex items-center justify-center space-x-2"
                >
                  <FiMessageCircle className="w-5 h-5" />
                  <span>WhatsApp</span>
                </button>
                <button className="flex-1 border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white py-3 px-6 rounded-lg font-semibold transition duration-200 flex items-center justify-center space-x-2">
                  <FiMessageCircle className="w-5 h-5" />
            ...
            <div className="bg-white rounded-lg border border-gray-200 mb-6">
              <div className="border-b border-gray-200">
                <nav className="flex overflow-x-auto">
                  {["overview", "description", "features", "location", "contact"].map((tab) => (
                    <button
                      key={tab}
                ...
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-4">Key Details</h4>
                        <div className="space-y-3">
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Property Type</span>
                            <span className="text-gray-900 font-medium">Apartment</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Furnishing</span>
                            <span className="text-gray-900 font-medium">Furnished</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Parking</span>
                            <span className="text-gray-900 font-medium">2 Covered</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Maintenance Fee</span>
                            <span className="text-gray-900 font-medium">AED 1,200/year</span>
                          </div>
                        </div>
                      </div>

                      <div>
                        <h4 className="font-semibold text-gray-900 mb-4">Building Information</h4>
                        <div className="space-y-3">
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Building Name</span>
                            <span className="text-gray-900 font-medium">Marina Heights</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Floor</span>
                            <span className="text-gray-900 font-medium">15th Floor</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">View</span>
                            <span className="text-gray-900 font-medium">Sea View</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-100">
                            <span className="text-gray-600">Status</span>
                            <span className="text-green-600 font-medium">Ready to Move In</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                {activeTab === "features" && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {Object.entries(property.amenities).map(([category, features]) => (
                        <div key={category}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <div className="space-y-3">
                          {property.locationDetails.landmarks.map((landmark, index) => (
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {property.locationDetails.schools.map((school, index) => (
                            <div key={index} className="flex items-center space-x-2 py-2 border-b border-gray-100">
                              <FiCheck className="w-4 h-4 text-green-500 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <div className="flex items-start space-x-4 mb-6">
                        ...
                        />
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900 text-lg">{property.agent.name}</h4>
                          ...
                          <div className="flex items-center space-x-4 mt-2">
                            ...
                            <span className="text-sm text-gray-600">{property.agent.reviews} reviews</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <div className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200">
                            ...
                            <span className="text-gray-900 font-medium">{property.agent.phone}</span>
                          </div>
                          <div className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex justify-between">
                            ...
                            <span className="text-gray-900">{property.agent.memberSince}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Response Rate:</span>
                            <span className="text-gray-900">{property.agent.responseRate}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Response Time:</span>
                            <span className="text-gray-900">{property.agent.responseTime}</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Similar Properties</h2>
                ...
                {similarProperties.map((similarProperty) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-gray-600 text-xs mb-2">{similarProperty.location}</p>
            ...
            <div className="sticky top-6 space-y-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() => handleContactAgent('whatsapp')}
                    className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-semibold transition duration-200 flex items-center justify-center space-x-2"
                  >
                    <FiMessageCircle className="w-5 h-5" />
                    <span>WhatsApp</span>
                  </button>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="text-gray-900 font-medium">{property.reference}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    <span className="text-gray-600">Posted:</span>
                    <span className="text-gray-900 font-medium">{property.datePosted}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-gray-100">
