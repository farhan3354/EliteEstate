  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div className="mb-4 sm:mb-0">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Manage your appointments and viewings
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="lg:col-span-3 bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-0">
              February 2024
            </h2>
            <div className="flex space-x-2">
              <button className="px-3 py-2 sm:px-4 sm:py-2 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200 text-xs sm:text-sm">
                Today
              </button>
              <button className="px-3 py-2 sm:px-4 sm:py-2 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200 text-xs sm:text-sm">
                Week
          ...
          <div className="bg-gray-100 rounded-xl p-6 sm:p-8 text-center">
            <FiCalendar className="w-8 h-8 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-3 sm:mb-4" />
            <p className="text-gray-600 text-sm sm:text-base">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
            ...
            <div className="space-y-2 sm:space-y-3">
              <button className="w-full text-left px-3 py-2 sm:px-4 sm:py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors duration-200">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    <span
                      className={`px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${getTypeColor(
                        appointment.type
                      )}`}
                    >
                      {appointment.type}
                  ...
                  {/* Appointment Details */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 text-sm text-gray-600">
                ...
                {/* Action Buttons */}
                <div className="mt-4 lg:mt-0 lg:ml-4 lg:pl-4 flex flex-col sm:flex-row lg:flex-col gap-2">
                  <button className="px-3 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 text-xs sm:text-sm w-full sm:w-auto lg:w-full">
                    Reschedule
                  </button>
                  <button className="px-3 py-2 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors duration-200 text-xs sm:text-sm w-full sm:w-auto lg:w-full">
                    Cancel
                  </button>
                </div>
              </div>
