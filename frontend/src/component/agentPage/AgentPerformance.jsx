    ...
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <select
          ...
          className="px-4 py-2 sm:py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base w-full sm:w-auto"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
          ...
          <div className="bg-gray-100 rounded-xl p-6 sm:p-8 text-center">
            <FiTrendingUp className="w-8 h-8 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-3 sm:mb-4" />
            <p className="text-gray-600 text-sm sm:text-base">
