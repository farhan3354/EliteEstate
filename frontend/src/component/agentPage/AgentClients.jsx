            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                     {client.profileImage ? (
                ...
                <div className="mt-4 lg:mt-0 lg:text-right lg:pl-4">
                  ...
                  <div className="font-semibold text-gray-900 text-sm sm:text-base">
                    {client.budget !== "N/A" ? client.budget : `${client.properties} properties`}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-600 mt-1">
                     {client.type === 'Buyer' ? 'Interested in' : 'Owns'} {client.properties} properties
                  </div>
                </div>
              </div>
            </div>
